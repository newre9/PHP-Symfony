...
class OrdersController extends AbstractController
{
    ...
    public function new(Request $request,ShopcartRepository $shopcartRepository): Response
    {
        ...
        $submitedToken = $request->request->get('token');//get csrf token information

        if ($this->isCsrfTokenValid('form-order', $submitedToken)) {
            ...
            if ($form->isSubmitted()) {
                ...
                $query->execute();
                $this->addFlash('success', 'sparişiniz başarıyla gerçekleşmiştir.Teşekkür ederiz');
